...
```{r plotMareyHeterochiasmy, message=FALSE, warning=FALSE, echo=TRUE, fig.height = 4, fig.width = 8, fig.align="center", fig.cap = "Female, male and sex-averaged Marey maps of *Homo sapiens* chromosome 1."}
...
```{r plotMapHeterochiasmy, message=FALSE, warning=FALSE, echo=TRUE, fig.height = 4, fig.width = 8, fig.align="center", fig.cap = "Female, male and sex-averaged recombination landscape of *Homo sapiens* chromosome 1. The shaded area is the 95% confidence interval around the mean estimate."}
