...
Markers can be masked (unmasked) in genomic intervals with the `mask.interval` function (`unmask.interval` respectively).
...
When you compare different populations or different studies, the recombination maps may not share physical positions (markers are not shared).


Predict new shared positions (bins?)
...
Between two contrasted species, Arabidopsis and maize.
